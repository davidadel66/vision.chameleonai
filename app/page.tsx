  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center min-h-screen relative z-10">
        ...
        <div
          className={`text-xl text-center transition-all duration-[2000ms] ease-in-out delay-1000 
              ${isVisible ? 'opacity-100' : 'opacity-0'}`}
        >
          <Link href="/dashboard">
            <Button
              className={`px-9 py-4 text-large transition-all duration-300 hover:scale-110 `}
            >
              Get Started
            </Button>
          </Link>
